...
function _doMagSearch(){
  ...
  results.forEach(function(o){
    ...
    html += '<div class="mag-edit-row mag-edit-row--triple mag-edit-row--prices">';
    html += '<div class="mag-edit-col mag-edit-col--vend"><div class="mag-edit-label mag-edit-label--vend">Vend.</div><div class="mag-edit-price-wrap"><button type="button" class="mag-price-check-btn" title="Aggiorna solo il timestamp prezzo" onclick="magCardPrezzoVerificato(' + i + ')">✓</button>' + dotHtml + '<input type="text" class="mag-edit-input mag-edit-input--price" value="' + esc(String(prezzoVend || '')) + '" onblur="magCardSaveField(' + i + ',\'prezzo\',this.value)"><button type="button" class="mag-promo-toggle mag-promo-toggle--inline' + ((r.isPromo===true && String(r.promoTipo||'')==='G') ? ' is-on' : '') + '" onclick="magCardTogglePromoG(' + i + ')">[G]</button></div></div>';
    html += '<div class="mag-edit-col mag-edit-col--old"><div class="mag-edit-label">Vec.</div><input type="text" class="mag-edit-input mag-edit-input--meta" value="' + esc(String(prezzoVec === '—' ? '' : prezzoVec)) + '" onblur="magCardSaveField(' + i + ',\'prezzoOld\',this.value)"></div>';
    html += '<div class="mag-edit-col mag-edit-col--acq"><div class="mag-edit-label">Acq.</div><input type="text" class="mag-edit-input mag-edit-input--meta" value="' + esc(String(prezzoAcq === '—' ? '' : prezzoAcq)) + '" onblur="magCardSaveField(' + i + ',\'prezzoAcquisto\',this.value)"></div>';
    html += '</div>';
    html += '</div>';
